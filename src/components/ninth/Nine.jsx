  ...
  const send = async (user) => {
    ...
    if (change) {
      reply = await Axios.post(
        "https://api-production-b6bc.up.railway.app/api/user/coffee",
        user
      )
    } else {
      reply = await Axios.post(
        "https://api-production-b6bc.up.railway.app/api/user/anothercoffee",
        user
      )
    }
      ...
      {change ? (
        <div className="second">
          <div className="postiton">
            ...
            >
              <a
                href="https://bereketera.github.io/paralel-form/min.html"
